...
//
	...
	{
        System.out.println("Find SubCategories by Category Name");
	...
	@GetMapping("api/v1/range/subcategories/{category_id}")
	public ResponseEntity<Object> findProductsByCategoryId(@PathVariable("category_id") Integer categoryId) throws Exception
	{
		System.out.println("Find SubCategories by CategoryId");
		...
		try {
			List<Category> categories = new ArrayList<>();
		     ...
		     categories = repository.findByCategoryId(categoryId);
